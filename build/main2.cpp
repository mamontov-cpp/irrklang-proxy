...
int main(int argc, const char** argv)
{
	...
	ISoundEngine* engine = ikProxy::createIrrKlangDevice(ESOD_AUTO_DETECT, ESEO_DEFAULT_OPTIONS, 0, IRR_KLANG_VERSION);
	...
	ikProxy::SoundEngine::play2DFileName(engine, "getout.ogg", true, false, false, irrklang::ESM_AUTO_DETECT,false);
	...
	do
	{
		...
		// play a single sound
		ikProxy::SoundEngine::play2DFileName(engine, "bell.wav", false, false, false, irrklang::ESM_AUTO_DETECT,false);
	}
	while(getch() != 'q');
	...
	ikProxy::SoundEngine::drop(engine); // delete engine
